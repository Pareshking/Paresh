    ...
    return ResearchProviderPacket(
        ...
        contradictions=(
            ContradictionFinding(
                ...
                original_claim_refs=tuple(ref("FY26 revenue rose 23% to INR 6,813 crore, with CDMO revenue up 36% to INR 2,080 crore and Affordable Medicines up 18% to INR 4,733 crore.")),
                counter_evidence_refs=tuple(ref("Laurus's FY26 business review notes that tender cycles and pricing dynamics can influence near-term FDF revenue phasing even while the overall outlook remains positive.")),
            ),
            ContradictionFinding(
                hypothesis="Can the large capex program translate into utilisation and commercial CDMO revenue without creating a balance-sheet drag?",
                ...
                original_claim_refs=tuple(ref("A September 2026 investor presentation shows Q1 FY27 capex of about INR 394 crore and more than INR 3,000 crore of proposed cumulative capex across FY27-FY28.")),
                counter_evidence_refs=tuple(ref("The reviewed disclosures do not establish the exact utilisation ramp and return profile of the full FY27-FY28 capex program.")),
            ),
            ContradictionFinding(
                hypothesis="Are the CDMO pipeline, filings and quality record strong enough to support multi-year customer conversion?",
                ...
                original_claim_refs=tuple(ref("Laurus reported 125+ active CDMO projects across clinical and commercial stages during FY26.")),
                counter_evidence_refs=tuple(ref("FY26 business review states that dedicated CMO oral-dosage capacity at Vizag commenced operations and that the KRKA JV facility was progressing toward Phase 1 completion in mid-2027.")),
            ),
            ContradictionFinding(
                hypothesis="How exposed is near-term profitability to tender cycles, pricing pressure and project/approval timing?",
                ...
                original_claim_refs=tuple(ref("Independent results reporting confirms Q1 FY27 revenue of INR 2,026.31 crore and PAT of INR 362.07 crore, with PAT up about 124% YoY.")),
                counter_evidence_refs=tuple(ref("The reviewed disclosures do not quantify the sensitivity of FY27 earnings to individual tender outcomes or customer approval delays.")),
            ),
        ),
