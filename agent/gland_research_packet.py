    ...
    return ResearchProviderPacket(
        ...
        contradictions=(
            ...
            ContradictionFinding(
                ...
                original_claim_refs=(ref("Management said capacity creation was a key priority and that brownfield and greenfield expansion initiatives were progressing across the manufacturing network."),),
                counter_evidence_refs=(ref("Gland reported that Saudi Arabia experienced supply disruptions and that NUPCO tender awards had been delayed."),),
            ),
        ),
