    ...
    return ResearchProviderPacket(
        ...
        causal_findings=(
            ...
            CausalFinding(
                ...
                uncertainty="No RBI decision on any pending One97-affiliated licence application was found in the reviewed materials, so BofA's reputational-overhang caveat remains an analyst opinion, not a confirmed regulatory outcome.",
                evidence_refs=(
            ...
            CausalFinding(
                ...
                uncertainty="The reviewed materials do not disclose lending-partner concentration or a multi-quarter delinquency trend, so the durability of 'robust' credit-quality claims cannot be independently verified.",
                evidence_refs=(
