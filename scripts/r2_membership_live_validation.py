...
def main() -> int:
    ...
    print(json.dumps({"dataset": MEMBERSHIP_DATASET, "as_of": args.as_of,
        "revision_sha256": ref.revision_sha256, "manifest_key": ref.manifest_key,
        "object_key": ref.object_key, "member_count": len(members),
        "consumer_acceptance": "PASS"}, sort_keys=True))
    return 0
