...
print(f"STAGE4B_PAYTM_SINGLE_SOURCED_DOMAINS={len(dossier.audit.domains_single_sourced)}")
for item in dossier.audit.domains_single_sourced:
    print(f"STAGE4B_PAYTM_SINGLE_SOURCED_DOMAIN_DETAIL={item}")
print(
    "STAGE4B_PAYTM_SINGLE_SOURCED_FINDINGS="
