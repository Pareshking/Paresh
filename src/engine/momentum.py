...
def clean_holidays(df: Optional[pd.DataFrame]) -> pd.DataFrame:
...
def compute_ffill_pct(raw_df: Optional[pd.DataFrame]) -> pd.Series:
...
def _normalize_ticker_cols(df: Optional[pd.DataFrame]) -> Optional[pd.DataFrame]:
    if df is None or df.empty:
        return df
    res = df.copy()
...
class MomentumEngine:
    ...
    def __init__(
        ...
        *,
        ...
        self.momentum_scores: Optional[pd.DataFrame] = None
        self.exp_reg_scores: Optional[pd.DataFrame] = None
        self.residual_ranks: Optional[pd.Series] = None
        self.ind_rel_ranks: Optional[pd.Series] = None
        self.vol_mgd_ranks: Optional[pd.Series] = None
    ...
    def get_rankings(
        ...
        *,
        close_prices_df: Optional[pd.DataFrame] = None,
        high_prices_df: Optional[pd.DataFrame] = None,
