...
class PortfolioOptimizer:
    ...
    def __init__(self, log_returns_df: pd.DataFrame, sector_map: Optional[Dict[str, str]] = None):
    ...
    def summary(self, weights: pd.Series, rank_df: Optional[pd.DataFrame] = None) -> pd.DataFrame:
