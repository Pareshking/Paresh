...
Section-C implementation and live publication state on main:
...
- C4 dated market-cap history — 21 explicit snapshots from 2026-08-18 through 2026-09-18, 15,750 rows; live R2 publication/read-back verified.
...
- full source-completeness and consumer acceptance tests;
- point-in-time universe reconstruction against archived membership.
...
The Section-C datasets are at different maturity levels:
